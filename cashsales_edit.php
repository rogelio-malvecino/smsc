<?php
	...
	if ($_REQUEST['Start'] == 2)
		{															
			...
			include ("datasource.php");					
			$mResult = $mysqli->query("Call sp_CashSalesHDR_Update('".$_SESSION['UserID']."','"
																  	 .$mControlNo."','"
																     .$mControlNo_."','"
																     .$mCSDate."','"
...
<html>
<head>
	<title>Update Cash Sales</title>
	<link href="../global/mystyle.css" rel="stylesheet" type="text/css" >
	<script language="JavaScript" src="Functions.js"></script>

</head>
<body background="../images/background.JPG" onLoad="document.frmFinancial.cboMonth1.focus(); eCashSales_LoadAccount();"> 
<form name="frmFinancial" action="cashsales_edit.php" method="post">
												...
												<table width="100%" class="title1">
                                                	<tr>
														<td colspan="4" class="title1" align="center">
                                                        	<font size="+1">CASH SALES (UPDATE)</font>
                                                        </td>
													</tr>
													<tr>
														<td colspan="4" align="center" nowrap class="title1">
                                                          	<input type="button" name="cmdNew" class="detail1" value="  Create New Record "  <?php if ($mAccess2 == '') { ?>disabled<?php } ?> onClick="javascript:eCashSales_Action(1);">
                                                            <input type='button' name='cmdDelete' class='detail1' value='Delete Account(s)' <?php if ($mAccess5 == '') { ?>disabled<?php } ?> onClick='javascript:eCashSales_DeleteAccount();' tabindex="0">
                                                            <input type="button" name="cmdSave" class="detail1" value="  [F8] - Save  "  <?php if ($mAccess3 == '' || $mOk == 1) { ?>disabled<?php } ?> onClick="javascript:eCashSales_Action(2);">
                                                            <input type="button" name="cmdPost" class="detail1" value="  [F9] - Post "  <?php if ($mAccess6 == '' || $mOk == 1) { ?>disabled<?php } ?> onClick="javascript:eCashSales_Action(4);" tabindex="14">
                                                           <input type="button" name="cmdSearch" class="detail1" value="  Search/List Record(s)  " onClick="javascript:eCashSales_Action(3);">
														</td>
													</tr>
											  </table>
											</td>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="1" bordercolor="#FFFFFF">
										...
										<tr bgcolor="#EBEBEB" onMouseOver="this.style.backgroundColor='#FFFFFF'" onMouseOut="this.style.backgroundColor=''">
											...
											<td colspan="2" class="detail1">
												&nbsp;<input name="txtReferenceNo" id="txtReferenceNo" type="text" size="9" maxlength="15" value="<?php echo $mReferenceNo ?>" class="detail1" tabindex="4" onKeyUp="eCashSales_SearchVoyageReference();" autocomplete="off">
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="1" class="title5">
                                                    <tr>
														...
														<td width="87%" align="left" class="title5">
															<input type="text" name="txtAccountID" id="txtAccountID" size="5" maxlength="5" class="detail13" tabindex="7" onKeyPress="javascript:eCashSales_EnterAccountID(event);">
														</td>
                                                    </tr>
                                                    <tr>
														<td width="13%" align="left" class="title5">
														...
														<td width="87%" align="left" class="title5">
                                                            <select name="cboAccountID" class="detail1" tabindex="8" onChange="javascript:eCashSales_SearchAccount_();" onKeyPress="javascript:eCashSales_EnterAccountID_(event);">
...
?>
                                                    ...
                                                    <tr>
														...
														<td width="87%" align="left" class="title5">
                                                            <select name="cboSubsidiaryID" class="detail1" onKeyPress="javascript:eCashSales_EnterSubsidiaryID(event);" tabindex="9">
...
?>
                                                    ...
                                                    <tr>
														...
														<td width="87%" align="left" class="title5">
                                                            <input type="text" Name="txtDebit" id="txtDebit" size="10" value="0.00" class="detail13" dir="rtl" onKeyPress="javascript:eCashSales_EnterSave(event);" tabindex="10">
														</td>
                                                    <tr>
														<td width="13%" align="left" class="title5">
															Credit:
														...
														<td width="87%" align="left" class="title5">
                                                            <input type="text" Name="txtCredit" id="txtCredit" size="10" value="0.00" class="detail13" dir="rtl" onKeyPress="javascript:eCashSales_EnterSave(event);" tabindex="11">
                                                   		</td>
                                               	  	</tr>
											  	</table>
											</td>
