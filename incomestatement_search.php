...
<html>
<head>
	<title>Attachment to Financial Statements</title>
...
<form name="frmFinancial" action="incomestatement_search.php" method="post">
												...
												<table width="100%" class="title1">
													<tr>
														<td colspan="4" class="title1" align="center">
                                                        	<font size="+1">INCOME STATEMENT (PRINT)</font>
                                                        </td>
													</tr>
											  </table>
											</td>
...
?>
                                        ...
                                        <tr bgcolor="#FFFFFF">
                                        	<td colspan="2" align="center">
												<input type="button" name="cmdPrint" class="detail1" value="Print" onClick="javascript:IncomeStatement_Print('<?php echo $_SESSION['UserID'] ?>')" <?php if ($mAccess == '') { ?>disabled<?php } ?>>                   
                                      		</td>
                                        </tr>
									</table>											
								</td>
