...
<form name="frmLedger" action="generalledger_search.php" method="post">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="1" bordercolor="#FFFFFF">
                                        <tr bgcolor="#EBEBEB" onMouseOver="this.style.backgroundColor='#FFFFFF'" onMouseOut="this.style.backgroundColor=''">
                                            ...
                                            <td width="82%" colspan="5" class="detail1">
                                                &nbsp;<select name="cboAccountID" class="detail1" onChange="javascript:GeneralLedger_LoadSubsidiary();">
...
?>
                                  ...
                                  <tr bgcolor="#EBEBEB" onMouseOver="this.style.backgroundColor='#FFFFFF'" onMouseOut="this.style.backgroundColor=''">
                                        ...
                                        </tr>					<tr bgcolor="#EBEBEB" onMouseOver="this.style.backgroundColor='#FFFFFF'" onMouseOut="this.style.backgroundColor=''">
                                        ...
                                        <tr valign="top" bgcolor="#FFFFFF">
                                            <td colspan="7" align="center">
                                                &nbsp;<input type="button" name="cmdSearch" class="detail1" value="Search" onClick="javascript:GeneralLedger_Search(<?php echo $mAccountID ?>);" tabindex="1">
                                            </td>
                                        </tr>
                                	</table>	
                                    <div id='Table'></div>											
