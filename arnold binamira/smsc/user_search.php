												...
												<table width="100%" class="title1">
													<tr>
														<td colspan="4" class="title1" align="center">
                                                        	<font size="+1">USER SETUP (LISTING)</font>
                                                        </td>
													</tr>
													<tr>
														<td colspan="4" align="center" nowrap class="title1">
                                                                                                                    <a href="user_create.php" class="makeFancy"><input type="button" name="cmdNew" class="detail1" value="  Create New Record "  <?php if ($mAccess1 == '') { ?>disabled<?php } ?>></a>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="1" bordercolor="#FFFFFF">
                                        ...
                                        <tr valign="top">
                                            <td colspan="5" align="center" bgcolor="#EBEBEB">
                                                <input type="button" name="cmdSearch" class="detail1" value="Search" onClick="javascript:searchContent('user_ajax.php?fname='+document.getElementById('userFirstName').value+'&lname='+document.getElementById('userLastName').value)">
                                            </td>
                                        </tr>
                                    </table>
                                    <div id='Table'></div>
