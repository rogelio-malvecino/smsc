...
<html>
<head>
	<title>Cash Receipts Masterfile</title>
...
<body background="../images/background.JPG" onLoad="javascript:CashReceipts_Search();"> 
<form name="frmJournal" action="cashreceipts_search.php" method="post"> 
												...
												<table width="100%" class="title1">
													<tr>
														<td colspan="4" class="title1" align="center">
                                                        	<font size="+1">CASH RECEIPTS (LISTING)</font>
                                                        </td>
													</tr>
													<tr>
														<td colspan="4" align="center" nowrap class="title1">
                                                          	<input type="button" name="cmdNew" class="detail1" value="  Create New Record "  <?php if ($mAccess2 == '') { ?>disabled<?php } ?> onClick="javascript:CashReceipts_Action(1);">
                                                            <input type="button" name="cmdSearch" class="detail1" value="  Search/List Record(s)  " onClick="javascript:CashReceipts_Action(2);">
														</td>
													</tr>											  
											  </table>
											</td>
								...
								<td>
									<table width="100%" border="0" cellspacing="0" cellpadding="1" bordercolor="#FFFFFF">
                                        <tr bgcolor="#EBEBEB" onMouseOver="this.style.backgroundColor='#FFFFFF'" onMouseOut="this.style.backgroundColor=''">
                                            <td colspan="2" class="detail1">&nbsp;Enter CS#&nbsp;</td>
                                        ...
                                        <tr bgcolor="#EBEBEB" onMouseOver="this.style.backgroundColor='#FFFFFF'" onMouseOut="this.style.backgroundColor=''">
                                            <td colspan="2" class="detail1">&nbsp;Select CR Date (From)</td>
											<td>
										...
										<tr valign="top" bgcolor="#EBEBEB">
                                            <td colspan="7" align="center" class="detail1">
                                                &nbsp;<input type="button" name="cmdSearch" class="detail1" value="Search" <?php if ($mAccess1 == ''){ ?>disabled<?php } ?> onClick="javascript:CashReceipts_Search();" tabindex="1">
                                            </td>
                                        </tr>
									</table>											
									<div id='Table'></div>											
