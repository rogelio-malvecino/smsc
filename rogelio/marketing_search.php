...
<div id="productForm">
	<div id="buttonPos">
    	<a href="marketing_create.php"  class="addProduct" ><input type="button" value="CREATE"id="buttonCreate" /></a>
    ...
    <div style="margin:0 auto;margin-bottom:15px;">
		 <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
        	...
        	<thead><tr class="title">
            	<th class="btitle" width="7%">#</th><th width="30%">MARKETING CODE</th><th>MARKETING NAME</th><th width="10%">ACTION</th>
        		</tr>
            </thead>
            <!--loop the record-->
            <?php $i=1 ?>
            ...
            <?php while ($row = $query->fetch_array(MYSQLI_BOTH)) 
            	...
            	<tr class="del<?php echo $row[0] ?>">
                    ...
                    <td>
                    <span style="padding-left:10px"><a href="marketing_update.php?id=<?php echo $row[0] ?>" class="editProduct"><img src="icons/EDITS.ico" /></a></span><span style="padding-left:10px; cursor:pointer;" class="delMarketing" id="<?php echo $row[0] ?>"><a href="#" title="DELETE"><img src="icons/DELETE.ico"/></a></span>
                    </td>
                </tr>
            	<?php } ?>
            </tbody>
