...
<table width="790" border="0" cellspacing="0" cellpadding="0" align="center">
				...
				<tr bgcolor="#FFFFFF">
					<td>
						<table bgcolor="#CCCCCC" width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
							...
							<tr>
								<td>
									<table width="100%" border="1" cellspacing="0" cellpadding="6" bordercolor="#00CC00">
										<tr>
											<td width="22%" align="left" class="detail1" rowspan="2" bgcolor="#FFFFFF">
												&nbsp;<img align="middle" src="../images/alertSuccess.gif">
												&nbsp;<?php echo substr($_SESSION['SysMsg'],0,130) ?>&nbsp;
										  	</td>
										</tr>
									</table>											
								</td>
	...
	<tr height="0">
		...
		<td valign="top">	
			<img border="0" src="../images/bg_bottom.gif" width="790" height="17">
		</td>
		<td align="left">
