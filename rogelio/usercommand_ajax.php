...
<table width='100%' id='example' class='display' cellpadding='0' cellspacing='0' >
		<thead>
		<tr class='title'>
		<th class='btitle' width='19%'>EMPLOYEE NUMBER</th>
		<th>FIRST NAME</th>
		<th>LAST NAME</th>
					...
					$display .="<tr>
							...
							<td>
								 <span style='padding-left:10px'>
                                                                        <a href='usercommand_create.php?id=$id' class='makeFancy' title='ADD ACCESS'>
                                                                            <img src='icons/add.ico' />
                                                                        </a>
                                                                  </span>
                                                                  <span style='padding-left:10px'>
                                                                            <a href='usercommand_create.php?id=$id' class='makeFancy' title='REMOVE ACCESS'>
                                                                                <img src='icons/REMOVE1.ico' />
                                                                            </a>
                                                                    </span>
							</td>
						         </tr>";
