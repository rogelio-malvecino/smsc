...
<html>
<head>
	<title>Control Account Masterfile</title>
	<link href="../global/mystyle.css" rel="stylesheet" type="text/css" >
    <script language="JavaScript" src="../global/Functions.js"></script>
	
</head>
<body background="../images/background.JPG" onLoad="javascrit:ControlAccount_Search();"> 
<form name="frmFinancial" action="controlaccount_search.php" method="post">
												...
												<table width="100%" class="title1">
													...
													<tr>
														<td colspan="4" align="center" nowrap class="title1">
                                                          	<input type="button" name="cmdNew" class="detail1" value="  Create New Record "  <?php if ($mAccess1 == '') { ?>disabled<?php } ?> onClick="javascript:ControlAccount_Action(1);">
								...
								<td>
									<table width="100%" border="0" cellspacing="0" cellpadding="1" bordercolor="#FFFFFF">
                                        <tr bgcolor="#EBEBEB" onMouseOver="this.style.backgroundColor='#FFFFFF'" onMouseOut="this.style.backgroundColor=''">
                                            <td colspan="2" class="detail1">&nbsp;Select Account Group&nbsp;</td>
                                            <td class="detail1">
                                                <select name="cboGroupID" class="detail1" >
                                                ...
                                                if (mysqli_num_rows($mResult) > 0)
                                                    {
                                                        while ($ado = $mResult->fetch_array(MYSQLI_BOTH))
                                                            { 
?>
                                                                <option value="<?php echo $ado["GroupID_cd"] ?>"><?php echo $ado["GroupName_tx"] ?></option>
<?php
                                                            }
                                                    }
                                                mysqli_close($mysqli);
?>
                                        ...
                                        <tr bgcolor="#EBEBEB" onMouseOver="this.style.backgroundColor='#FFFFFF'" onMouseOut="this.style.backgroundColor=''">
                                            <td colspan="2" class="detail1">&nbsp;Enter Account Code&nbsp;</td>
                                            <td width="82%" class="detail1">
                                                <input type="text" name="txtAccountID" id="txtAccountID" maxlength="5" size="5" class="detail1">
                                            </td>
                                      	</tr>
                                        <tr bgcolor="#EBEBEB" onMouseOver="this.style.backgroundColor='#FFFFFF'" onMouseOut="this.style.backgroundColor=''">
                                            <td colspan="2" class="detail1">&nbsp;Enter Account Title&nbsp;</td>
                                            <td class="detail1">
                                                <input type="text" name="txtAccountDesc" maxlength="80" size="80" class="detail1" onKeyUp="SearchControlName();" autocomplete="off"><BR>
                                            	<div id="controlname"></div>
                                          </td>
                                        </tr>
                                        <tr valign="top">
                                            <td colspan="5" align="center" bgcolor="#EBEBEB">
                                                <input type="button" name="cmdSearch" class="detail1" value="Search" onClick="javascript:ControlAccount_Search();">
                                            </td>
                                        </tr>
                                    </table>											
                                    <div id='Table'></div>	
