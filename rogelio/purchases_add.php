<?php
	...
	if ($_REQUEST['Start'] == 1)
		{					
			$mControlNo = fp_Auto_FinancialNumber("PBID_cd","tb_tpurchaseshdr","1=1");
	...
	if ($_REQUEST['Start'] == 2)
		{															
			...
			include ("datasource.php");
			$mResult = $mysqli->query("Call sp_Purchases_Verify('_','".$_REQUEST['ControlNo']."')");
			if (mysqli_num_rows($mResult) > 0)
			...
			else
				{
					...
					include ("datasource.php");					
					$mResult = $mysqli->query("Call sp_PurchasesHDR_Insert('".$_SESSION['S_UserID']."','"
																	 .$mControlNo."','"
																	 .$mPBDate."','"
																	 .$mReferenceNo."',"
																	 .$mAmount.",'"
				...
				if ($mResult == 1)
					{							
						...
						$mResult = $mysqli->query("Call sp_PurchasesHDR_Update_('".$_REQUEST['ControlNo']."')");
						$mOk = 1;
					}							
				else
					{							
...
<body background="../images/background.JPG" onLoad="document.frmFinancial.cboMonth1.focus(); LoadAccount();"> 
<form name="frmFinancial" action="purchases_add.php" method="post">
												...
												<table width="100%" class="title1">
                                                	<tr>
														<td colspan="4" class="title1" align="center">
                                                        	<font size="+1">PURCHASES (NEW)</font>
                                                        </td>
													</tr>
													<tr>
														<td colspan="4" align="center" nowrap class="title1">
                                                          	<input type="button" name="cmdNew" class="detail1" value="  Create New Record "  <?php if ($mAccess2 == '') { ?>disabled<?php } ?> onClick="javascript:aPurchasesBook_Action(1);">
                                                            <input type='button' name='cmdDelete' class='detail1' value='Delete Account(s)' <?php if ($mAccess5 == '') { ?>disabled<?php } ?> onClick='javascript:aPurchasesBook_DeleteAccount();' tabindex="0">
                                                            <input type="button" name="cmdSave" class="detail1" value="  [F8] - Save  "  <?php if ($mAccess3 == '' || $mOk == 1) { ?>disabled<?php } ?> onClick="javascript:aPurchasesBook_Action(2);">
                                                            <input type="button" name="cmdSearch" class="detail1" value="  Search/List Record(s)  " onClick="javascript:aPurchasesBook_Action(3);">
														</td>
													</tr>
											  </table>
											</td>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="1" bordercolor="#FFFFFF">
										...
										<tr bgcolor="#EBEBEB" onMouseOver="this.style.backgroundColor='#FFFFFF'" onMouseOut="this.style.backgroundColor=''">
											...
											<td colspan="2" class="detail1">
												&nbsp;<input name="txtReferenceNo" id="txtReferenceNo" type="text" size="9" maxlength="15" value="<?php echo $mReferenceNo ?>" class="detail1" tabindex="4" onKeyPress="javascript:aPurchasesBook_SearchVoyageReference();" autocomplete="off">
										...
										<tr bgcolor="#EBEBEB" onMouseOver="this.style.backgroundColor='#FFFFFF'" onMouseOut="this.style.backgroundColor=''">
											...
											<td colspan="2" class="detail1">
												&nbsp;<input type="text" name="txtAmount" value="<?php echo $mAmount; ?>" class="detail1" size="9" maxlength="13" dir="rtl" tabindex="5" onKeyPress="javascript:aPurchasesBook_EnterKey(5,event);">												
                                                &nbsp;<font color="#FF0000" size="+1">*</font>
                                            </td>
										</tr>
										<tr bgcolor="#EBEBEB" onMouseOver="this.style.backgroundColor='#FFFFFF'" onMouseOut="this.style.backgroundColor=''">
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="1" class="title5">
                                                    <tr>
														...
														<td width="87%" align="left" class="title5">
															<input type="text" name="txtAccountID" id="txtAccountID" size="5" maxlength="5" class="detail13" tabindex="7" onKeyPress="javascript:aPurchasesBook_EnterAccountID(event);">
														</td>
                                                    </tr>
                                                    <tr>
														<td width="13%" align="left" class="title5">
														...
														<td width="87%" align="left" class="title5">
                                                            <select name="cboAccountID" class="detail1" tabindex="8" onChange="javascript:aPurchasesBook_SearchAccount_();" onKeyPress="javascript:aPurchasesBook_EnterAccountID_(event);">
...
?>
                                                    ...
                                                    <tr>
														...
														<td width="87%" align="left" class="title5">
                                                            <select name="cboSubsidiaryID" class="detail1" onKeyPress="javascript:aPurchasesBook_EnterSubsidiaryID(event);" tabindex="9">
...
?>
                                                    ...
                                                    <tr>
														...
														<td width="87%" align="left" class="title5">
                                                            <input type="text" Name="txtDebit" id="txtDebit" size="10" value="0.00" class="detail13" dir="rtl" onKeyPress="javascript:aPurchasesBook_EnterSave(event);" tabindex="10">
														</td>
                                                    <tr>
														<td width="13%" align="left" class="title5">
															Credit:
														...
														<td width="87%" align="left" class="title5">
                                                            <input type="text" Name="txtCredit" id="txtCredit" size="10" value="0.00" class="detail13" dir="rtl" onKeyPress="javascript:aPurchasesBook_EnterSave(event);" tabindex="11">
                                                   		</td>
                                               	  	</tr>
											  	</table>
											</td>
