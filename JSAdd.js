	...
	function aPurchasesBook_ComputeTotal(RowLocation)
		{
			...
			eval('document.frmFinancial.txtTotalDebit.value=\''+mTotalDebit.toFixed(2)+'\';');
			eval('document.frmFinancial.txtTotalCredit.value=\''+mTotalCredit.toFixed(2)+'\';');
...
function payrollfile_save(){
var mControlNumber = $("#ControlNumber").val();
var mDate = $("#createDate").val();
var mDate1 = $("#createDate1").val();
var mDate2 = $("#createDate2").val();

if (mDate == "" || mDate1 == "" || mDate2 =="" || mControlNumber==""){
...
$.ajax({ 
    type:"POST",
    data:({ControlNumber:mControlNumber, Date:mDate, Date1:mDate1, Date2:mDate2}),
    url:"payrollfile_saving.php"
}).done(function(msg){
	$("#menulocationcontents").html($("#usernav").val() + msg)
	$.fancybox.close();
	//$("#Date").val('');
	//$("#Date1").val('');
	//$("#Date2").val('');
...
function payrollcreateRecord(ControlNumber)
{
							var ajaxRequest = getAjaxRequest();
							ajaxRequest.onreadystatechange = function()
							{
							...
							var param= "";
							ajaxRequest.open("POST","payroll_create.php",true);
							ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
							ajaxRequest.send(param);		
